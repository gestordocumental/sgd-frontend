  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-B7vy70jP-NJH5J6S2.js"));
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-Bmws3ikM-JLEFKMMV.js").then((n) => n.c));
...
//# sourceMappingURL=chunk-737UOSQN.js.map
